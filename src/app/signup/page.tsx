    ...
    <div className="min-h-screen flex bg-[#F0F2F5] text-gray-900 font-sans">
      ...
      <div className="hidden lg:flex w-1/2 bg-white border-r border-gray-200 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10 max-w-md">
          <h2 className="text-4xl font-bold mb-4">Start turning chats into revenue.</h2>
          <p className="text-gray-500 text-lg">
            Join thousands of businesses who use GrowFlow AI to automate their WhatsApp marketing. No credit card required.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-gray-500">Already have an account? <Link href="/signin" className="text-emerald-600 hover:text-emerald-700 font-medium">Sign in</Link></p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-8">
            ...
            <div>
              ...
              <input required name="name" type="text" className="mt-2 block w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all" placeholder="John Doe" />
            </div>
            <div>
